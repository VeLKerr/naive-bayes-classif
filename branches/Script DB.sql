...
Create Table Words(
  ...
  Spamcnt Number(3), -- кол-во повторений в спам-сообщениях
  hamCnt number(3) -- кол-во повторений в нормальных сообщениях
);
...
Create Table Messagescount(
  ...
  counter number(3) -- кол-во сообщений в выборке
);
-- создание первичного ключа
...
Create Table Classifiedmessages(
  ...
  принадлежность к классу SPAM, а 1 - к HAM.*/
);
-- создание первичного ключа
